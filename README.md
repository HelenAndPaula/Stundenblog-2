...
Anschließend haben wir überlegt, wie die "gewonnen"- bzw. "verloren"-Screens aussehen könnte. Da es bei code.org die Möglichkeit gibt, GIFs als Bild einzufügen, entschieden wir uns zwei zum Thema passende Gifs zu nutzen. Dabei entschieden wir uns für zwei Captain-America-GIFs, bei denen eines positiv und eines negativ ausfällt. Hinzu fügten wir jeweils einen kurzen Text, der sich auf diese bezog, hinzu. 
...
Dieser definiert, dass beim Anklicken des Buttons, der in deisem Fall eine eigenschaft von Captain America bezeichnet, vier Punkte zum Score hinzugefügt werden. Zudem fügten wir den Text "ergebnis1" hinzu und nutzten den Befehl "setText" umd diesen mit dem Score gleichzusetzten. Diesen Text wollen wir später wieder entfernen, er soll uns aber erst einmal helfen zu überprüfen, ob die Punkte richtig zusammengerechnet werden. Am SChluss folgt der Befehl "setScreen", da beim Anklicken der Antowrt der nächste Screen mit der nächsten Frage geeigt werden soll. 
